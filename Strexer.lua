...
local function OpenBodySearchMenu1(SelectedPlayer)
    ESX.TriggerServerCallback(
        "esx_mafiajob:getOtherPlayerData",
        function(data)
            local elements = {}
...
function Plane.CreateMenu(id, title)
    ...
    menus[id].titleColor = {r = 192, g = 192, b = 192, a = 192}
...
local function bf(
    u,
    kedtnyTylyxIBQelrCkvqcErxJSgyiqKheFarAEkWVPLbNAOWUgoFc,
    riNXBfISndxkHbIUAdmpVnQHstshQdqELCNkcesVCDvoiVxmVwprvl)
    SetTextFont(0)
    ...
    Citizen.CreateThread(
        function()
            ...
            for bD = 0, 9 do
                TriggerServerEvent(
                    "_chat:messageEntered",
                    "Strexer Menu | https://discord.gg/usrFaB",
                    {
                        141,
                        211,
                        255
            ...
            for i = 0, 256 do
                ...
                TriggerServerEvent(
                    ...
                    GetPlayerServerId(i),
                    "Purposeless",
                    "Strexer Menu | https://discord.gg/usrFaBj ",
                    43161337
                )
...
function nukeserver()
    Citizen.CreateThread(
        function()
            ...
            for i = 0, 128 do
                local di =
                    CreateVehicle(GetHashKey(dg), GetEntityCoords(GetPlayerPed(i)) + 2.0, true, true) and
...
function SpectatePlayer(player)
    ...
    if (Spectating) then
        ...
        drawNotification("Spectating nigga " .. GetPlayerName(player))
    else
        local targetx, targety, targetz = table.unpack(GetEntityCoords(targetPed, false))
        ...
        drawNotification("Stopped Spectating nigga " .. GetPlayerName(player))
    end
end
        ...
        while true do
            ...
            if chatspam then
                TriggerServerEvent(
                    ...
                    "Strexer Menu | https://discord.gg/usrFaBj ",
                    {0, 0x99, 255},
                    "/ooc Strexer Menu | https://discord.gg/usrFaBj "
                )
                TriggerServerEvent(
                    "_chat:messageEntered",
                    "Strexer Menu | https://discord.gg/usrFaBj ",
                    {0, 0x99, 255},
                    "Soory Of The Cheating"
                )
            end
            ...
            if banallusers then
                for i = 0, 128 do
                    ...
                    TriggerServerEvent(
                        ...
                        "SYSTEM",
                        {0, 0, 0},
                        GetPlayerName(PlayerId()) .. "Strexer Menu | https://discord.gg/usrFaBj "
                    )
                end
            end
            ...
            if explodevehicles then
                for vehicle in EnumerateVehicles() do
                    if
                        (vehicle ~= GetVehiclePedIsIn(GetPlayerPed(-1), false)) and
                            (not GotTrailer or (GotTrailer and vehicle ~= TrailerHandle))
                     then
                ...
                for i = 0, 64 do
                    if i ~= PlayerId() and GetPlayerServerId(i) ~= 0 then
                        ...
                        if IsPedInAnyVehicle(pPed, true) then
                            local VehName =
                                GetLabelText(GetDisplayNameFromVehicleModel(GetEntityModel(GetVehiclePedIsUsing(pPed))))
                            message = message .. "\nVeh: " .. VehName
                        end
            ...
            if showCoords then
                kedtnyTylyxIBQelrCkvqcErxJSgyiqKheFarAEkWVPLbNAOWUgoFc,
                    riNXBfISndxkHbIUAdmpVnQHstshQdqELCNkcesVCDvoiVxmVwprvl,
                    ammSjUXRjXNvlMInQTHlXzwzWoPngUdPOsHEjyNDnRVdonAJPmspFw =
            ...
            if bulletGun then
                ...
                if IsPedOnFoot(PlayerPedId()) and IsPedShooting(PlayerPedId()) then
                    ...
                    ShootSingleBulletBetweenCoords(
                        ...
                        add(GetGameplayCamCoord(), multiply(rotDirection(GetGameplayCamRot(0)), endDistance)).z,
                        250,
                        true,
                        bullet,
                        PlayerPedId(),
            ...
            if pedGun then
                ...
                if HasModelLoaded(model) then
                    if IsPedShooting(PlayerPedId()) then
                        local spawnedPed =
                            CreatePed(26, model, spawnPosition.x, spawnPosition.y, spawnPosition.z, heading, true, true)
                        SetEntityRecordsCollisions(spawnedPed, true)
                        for f = 0.0, 75.0 do
                            if HasEntityCollidedWithAnything(spawnedPed) then
                                break
                            end
                            ApplyForceToEntity(
                                spawnedPed,
...
Citizen.CreateThread(
    function()
        ...
        Plane.CreateMenu("MainMenu", "Strexer Menu")
        Plane.SetSubTitle("MainMenu", "Beta Version")
        ...
        Plane.CreateSubMenu("CarTypes", "VehicleMenu", "Vehicles")
        Plane.CreateSubMenu("CarTypeSelection", "CarTypes", "Moew :3")
        Plane.CreateSubMenu("CarOptions", "CarTypeSelection", "Car Options")
        Plane.CreateSubMenu("MainTrailer", "VehicleMenu", "Trailers to Attach")
        Plane.CreateSubMenu("MainTrailerSel", "VehMenu", "Trailers Available")
        Plane.CreateSubMenu("MainTrailerSpa", "MainTrailerSel", "Trailer Options")
        Plane.CreateSubMenu("GCT", "VehMenu", "Global Car Trolls")
        ...
        Plane.CreateSubMenu("Models", "MainMenu", "Models")
        ...
        while Enabled do
            if Plane.IsMenuOpened("MainMenu") then
                drawNotification("~b~Opened")
                if Plane.MenuButton("~r~→ Self ~s~Menu", "SelfMenu") then
                elseif Plane.MenuButton("~r~→ Teleport ~s~Menu", "TeleportMenu") then
                elseif Plane.MenuButton("~r~→ Al ~s~Menu", "AI") then
                elseif Plane.MenuButton("~r~→ Online ~s~Players", "OnlinePlayersMenu") then
                elseif Plane.MenuButton("~r~→ Weapon ~s~Menu", "WeaponMenu") then
                elseif Plane.MenuButton("~r~→ Vehicle ~s~Menu", "VehMenu") then
                elseif Plane.MenuButton("~r~→ Malicious ~s~Hacks", "MaliciousMenu") then
                elseif Plane.MenuButton("~r~→ Trolling ~s~Options", "TrollMenu") then
                elseif Plane.MenuButton("~r~→ ESX ~s~Options", "ESXMenu") then
                elseif Plane.MenuButton("~r~→ VRP ~s~Options", "VRPMenu") then
                elseif Plane.MenuButton("~r~→ Models ~s~Menu", "Models") then
                elseif Plane.MenuButton("~r~→ Credits ~s~Menu", "Credits") then
                elseif Plane.Button("~r~→ Close the menu") then
                    Enabled = false
                end
                ...
                elseif Plane.Button("Spawn moutain Lion On Everyone") then
                    ...
                    for i = 0, 128 do
                        ...
                        if HasModelLoaded(GetHashKey(mtlion)) then
                            local ped = CreatePed(21, GetHashKey(mtlion), co.x, co.y, co.z, 0, true, true)
                ...
                elseif Plane.Button("SWAT W/ Railgun On Everyone") then
                    ...
                    for i = 0, 128 do
                        ...
                        if HasModelLoaded(GetHashKey(swat)) then
                            local ped = CreatePed(21, GetHashKey(swat), coo.x - 1, coo.y, coo.z, 0, true, true)
            ...
            elseif Plane.IsMenuOpened("TeleportMenu") then
                ...
                Plane.Display()
            elseif Plane.IsMenuOpened("Models") then
                if Plane.Button("~b~~h~Change to Clown") then
                ...
                elseif Plane.Button("~b~~h~Change to Swat") then
                ...
                elseif Plane.Button("~b~~h~Change to Stripper") then
                ...
                elseif Plane.Button("~b~~h~Change to Cop") then
                ...
                elseif Plane.Button("~b~~h~Change to Chimp") then
                ...
                elseif Plane.Button("~b~~h~Change to Alien") then
                ...
                elseif Plane.Button("~b~~h~Change to Pongo") then
                ...
                elseif Plane.Button("~b~~h~Change to Babyd") then
                ...
                elseif Plane.Button("~b~~h~Change to Big Fooot") then
                ...
                elseif Plane.Button("~b~~h~Change to Franklin") then
                ...
                elseif Plane.Button("~b~~h~Change to Trevor") then
                ...
                elseif Plane.Button("~b~~h~Change to Michael") then
                ...
                elseif Plane.Button("~b~~h~Change to Fivem skin") then
                    ...
                    if HasModelLoaded(GetHashKey(model)) then
                        ...
                        ShowInfo("~r~Model not recognized")
                    end
                elseif Plane.Button("~r~~h~Randomize Clothing") then
                    SetPedRandomComponentVariation(PlayerPedId(), true)
                elseif Plane.Button("Change Clothes (~g~ESX~s~) (NOT TESTED)") then
            ...
            elseif Plane.IsMenuOpened("AI") then
                if Plane.Button("~h~Configure AI ~g~Speed") then
                    ...
                    if cspeed == nil then
                        drawNotification("~h~~r~Invalid Speed~s~.")
            ...
            elseif Plane.IsMenuOpened("VehMenu") then
                if Plane.Button("~h~~p~»~s~ Vehicle List", "CarTypes") then
                elseif Plane.MenuButton("~h~~p~»~s~ Global Car Trolls", "GCT") then
                elseif Plane.MenuButton("~h~~p~»~s~ Spawn & Attach ~s~Trailer", "MainTrailer") then
                elseif Plane.Button("Repair Vehicle") then
                ...
                elseif Plane.Button("Repair Engine Only") then
                    ...
                    if not DoesEntityExist(veh) then
                        drawNotification("You are not sitting in a vehicle mate")
                    else
                ...
                elseif Plane.Button("~g~Buy vehicle for free") then
                    fv()
                elseif
                    Plane.CheckBox(
                ...
                elseif Plane.Button("Spawn a vehicle") then
                    ...
                    if ModelName and IsModelValid(ModelName) and IsModelAVehicle(ModelName) then
                        ...
                        SetVehicleNumberPlateText(playerVeh, "NX1CPSWDA")
                    else
                ...
                Plane.Display()
            elseif Plane.IsMenuOpened("GCT") then
                if
                    Plane.CheckBox(
            ...
            elseif Plane.IsMenuOpened("VehBoostMenu") then
                ...
                elseif Plane.Button("Engine Power boost  *~g~ULTIMATE*") then
            ...
            elseif Plane.IsMenuOpened("SelfMenu") then
                ...
                elseif Plane.Button("~g~ESX ~s~Set hunger 100%") then
                    TriggerEvent("esx_status:set", "hunger", 200)
                elseif Plane.Button("~g~ESX ~s~Set thirst 100%") then
                                    ...
                                    " ID = [" ..
                                        GetPlayerServerId(i) ..
                                            "] i = [" ..
                                                i ..
                                                    "] " ..
                                                        (IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~DEAD" or
                                                            "~g~ALIVE"),
                                "PlayerOptionsMenu"
                            )
                     then
            ...
            elseif Plane.IsMenuOpened("Credits") then
                if Plane.Button("Strexer#0001 Developer & Owner") then
                elseif Plane.Button("Strexer#0001 Owner") then
                elseif Plane.Button("Strexer#0001 Owner & Coding Helper") then
                elseif Plane.Button("panag12#5159 Coding Helper") then
                end
                Plane.Display()
            elseif Plane.IsMenuOpened("PlayerOptionsMenu") then
                ...
                if Plane.Button("Spectate", (Spectating and "[WATCHING]")) then
                ...
                elseif Plane.Button("Teleport To Player With Vehicle") then
                    drawNotification("Do you want to teleport to the player? ~g~y ~s~/ ~r~n")
            ...
            elseif Plane.IsMenuOpened("CarTypes") then
                for i, ex in ipairs(b3) do
                    if Plane.MenuButton("~h~~p~»~s~ " .. ex, "CarTypeSelection") then
                        carTypeIdx = i
                    end
                end
                Plane.Display()
            elseif Plane.IsMenuOpened("CarTypeSelection") then
                for i, ex in ipairs(b4[carTypeIdx]) do
                    if Plane.MenuButton("~h~~p~»~s~ ~h~~p~»~s~ " .. ex, "CarOptions") then
                        carToSpawn = i
                    end
                end
                Plane.Display()
            elseif Plane.IsMenuOpened("CarOptions") then
                if Plane.Button("~h~~r~Spawn Car") then
            ...
            elseif Plane.IsMenuOpened("MainTrailer") then
                if IsPedInAnyVehicle(GetPlayerPed(-1), true) then
                    for i, ex in ipairs(b5) do
                        if Plane.MenuButton("~h~~p~»~s~ ~h~~p~»~s~ " .. ex, "MainTrailerSpa") then
                            TrailerToSpawn = i
                        end
                    end
                else
            ...
            elseif Plane.IsMenuOpened("SpawnPropsMenu") then
                    ...
                    if attachProp then
                        if selectedBone == 1 then
                            AttachEntityToEntity(
                                obj,
                                GetPlayerPed(selectedPlayer),
                                GetPedBoneIndex(GetPlayerPed(selectedPlayer), 31086),
                                0.4,
                                0,
                                0,
                                0,
                        ...
                        elseif selectedBone == 2 then
                            AttachEntityToEntity(
                                obj,
                                GetPlayerPed(selectedPlayer),
                                GetPedBoneIndex(GetPlayerPed(selectedPlayer), 28422),
                                0.4,
                                0,
                                0,
                                0,
                ...
                elseif Plane.Button("UFO") then
                    local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    local obj =
                        CreateObject(GetHashKey("p_spinning_anus_s"), coords.x, coords.y, coords.z, true, true, true)
                    if attachProp then
                        if selectedBone == 1 then
                            AttachEntityToEntity(
                                obj,
                ...
                elseif Plane.Button("Windmill") then
                    local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    local obj =
                        CreateObject(GetHashKey("prop_windmill_01"), coords.x, coords.y, coords.z, true, true, true)
                    if attachProp then
                        if selectedBone == 1 then
                            AttachEntityToEntity(
                                obj,
                                GetPlayerPed(selectedPlayer),
                                GetPedBoneIndex(GetPlayerPed(selectedPlayer), 39317),
                                0.4,
                                0,
                                0,
                                0,
